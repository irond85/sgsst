...
public class ControladorPpal {
	...
	public void exportarListadoDeEmpleadosEnPDF(HttpServletResponse response, Model mod)
	...
	public void exportarListadoDeEmpleadosEnExcel(HttpServletResponse response, Model mod)
			throws DocumentException, IOException {
	...
	public void exportarListadoDeAusentismoEnPDF(HttpServletResponse response, Model mod)
			throws DocumentException, IOException {
		response.setContentType("application/pdf");
	...
	public void exportarListadoDeAusentismoEnExcel(HttpServletResponse response, Model mod)
			throws DocumentException, IOException {
		response.setContentType("application/octet-stream");
	...
	public String generarReporteAreas(Model mod, @RequestParam("area") String area,
			@RequestParam("fechaInicial") Date fechaIni, @RequestParam("fechaFinal") Date fechaFin) {
