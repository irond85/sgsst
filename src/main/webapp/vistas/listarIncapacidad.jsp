<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <h3>Listado de Incapacidades &nbsp;<a href="/crearInc" style="text-decoration: none; "> <img
            src="https://findicons.com/files/icons/1014/ivista/256/plus.png" width="40" /></a> </h3>
      <br> <br>
      <a class=" btn btn-danger" onclick="pdf()" style="margin-left:80px;margin-top:-68px">Descargar PDF<span
          class="bi bi-file-pdf red-color"></a>
      <a class=" btn btn-success" onclick="excel()" style="margin-left:80px;margin-top:-68px">Descargar Excel<span
          class="bi bi-file-excel green-color"></a>

      <table class="table table-striped" id="lstInc">
        ...
        <tbody>
          <c:forEach items="${listaIncapacidades}" var="emp">
            <tr>
              ...
              <td>${emp.getEPS()}</td>
              <td>
                <fmt:formatNumber type="number" maxFractionDigits="2" value="${emp.getSalarioDia()}" />
              </td>
